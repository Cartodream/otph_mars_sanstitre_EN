...
// Fonction globale pour charger les POIs de la fondation
function loadFondationPOIs() {
    const fondationPoiList = document.getElementById('fondation-poi-list');
    if (!fondationPoiList || typeof poi === 'undefined') return;
    ...
    const fondationPOIs = poi.features.filter(feature => 
        ...
        (feature.properties.patrimoine_encours && feature.properties.patrimoine_encours !== null)
    );
        ...
        card.innerHTML = `
            ...
            <div class="poi-content">
                ...
                <div class="fondation-link">
                    <a href="${properties.fondation_courant || properties.patrimoine_encours}" target="_blank">Lien vers le site de la Fondation du Patrimoine</a>
                </div>
